...
# Easily produce a filename like "2025-06-20_11_20-output-of-command.log"
alias logdate "date '+%Y-%m-%d_%H_%M'"
...
# rustup
# -- can be found in `./conf.d/rustup.fish`

# uv
# -- can be found in `./conf.d/uv.env.fish`
